                ...
                <ContentTemplate>
                    <p>
                        <asp:DropDownList ID="ddlSearchAccount" runat="server" AutoPostBack="True" OnSelectedIndexChanged="ddlSearchAccount_SelectedIndexChanged">
                            ...
                            <asp:ListItem Value="By_Lastname">By Lastname</asp:ListItem>
                            <asp:ListItem Value="By_Firstname">By Firstname</asp:ListItem>
                            <asp:ListItem Value="By_Homephone">By Homephone</asp:ListItem>
