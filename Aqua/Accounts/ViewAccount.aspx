...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContentPlaceHolder" runat="server">
    <div class="mainContainer">
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Width="100%"
                        ...
                        <%--Equipment Tab--%>
                        <asp:TabPanel ID="WTETabPanel" runat="server" HeaderText="Equipment">
                            <ContentTemplate>
                                <div>
                                        ...
                                        <asp:FormView ID="fviewWTE" runat="server" DefaultMode="Insert">
                                            <InsertItemTemplate>
                                                ...
                                                <p>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ErrorMessage="Product Code"
                                                        ControlToValidate="txtProductCode" Display="Dynamic" ValidationGroup="valAddWTE"
                                                ...
                                                <p>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" Display="Dynamic"
                                                        ControlToValidate="txtDescription" ErrorMessage="Description" ValidationGroup="valAddWTE">*</asp:RequiredFieldValidator>
                                                </p>
                                                <%--manufacturer--%>
                                                <p>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" Display="Dynamic"
                                                        ControlToValidate="txtManufacturer" ErrorMessage="Manufacturer" ValidationGroup="valAddWTE">*</asp:RequiredFieldValidator>
                                                </p>
                                                <%--date obtained--%>
                                                <p>
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ErrorMessage="Date Obtained"
                                    ...
                                    <div class="mainContainer-innerSpacer">
                                        ...
                                        <asp:GridView ID="gviewWTE" runat="server" CssClass="gridviewBaseStyle" Width="100%"
                                            EmptyDataText="No records found. . ." AutoGenerateColumns="false" OnRowEditing="gviewWTE_RowEditing"
                                            OnRowDataBound="gviewWTE_RowDataBound" OnRowDeleting="gviewWTE_OnRowDeleting">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Product Code">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:HiddenField ID="hdnWTEID" runat="server" Visible="false" Value='<% # bind("wte_id") %>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <%--desc--%>
                                                ...
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkEditWTE" runat="server" CausesValidation="false" CommandName="Edit">Edit</asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <%--delete--%>
                                                <asp:TemplateField>
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkDeleteWTE" runat="server" CausesValidation="false" CommandName="Delete">Delete</asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                    ...
                                    <div class="mainContainer-innerSpacer">
                                        ...
                                        <asp:FormView ID="fviewAuthorizedMember" runat="server" DefaultMode="Insert">
                                            <InsertItemTemplate>
                                                ...
                                                <%--firstname--%>
                                                <p>
                                                    <asp:Label ID="Label47" runat="server" Text="First Name" CssClass="propertyLabel"></asp:Label>
                                                ...
                                                <%--lastname--%>
                                                <p>
                                                    <asp:Label ID="Label48" runat="server" Text="Last Name" CssClass="propertyLabel"></asp:Label>
                                        ...
                                        <h2>
                                            Click <span>
                                                <asp:LinkButton ID="lnkGoToServiceWorkOrder" OnCommand="lnkGoToServiceWorkOrder_OnCommand"
                                                    runat="server" CssClass="linkbutton-no-line" ToolTip="Add new Service Work">here</asp:LinkButton></span>
                                            to add a new Service Work
                                        </h2>
                                        <br />
                                        <br />
                                        <h2>
        ...
        <asp:Panel ID="pnlHomeAddressOnEdit" runat="server" Style="display: none; border: 0.2em solid gray;
                        ...
                        <EditItemTemplate>
                            ...
                            <p>
                                <asp:Label ID="Label6" runat="server" Text="Address Line 1" CssClass="propertyLabel">
                                    ...
                                    Text='<% # bind("addressLine1") %>' ValidationGroup="valEditHomeAddress"></asp:TextBox>
                                <asp:Label ID="Label11" runat="server" Text="*"></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtAddressLine1"
                                    Display="Dynamic" ErrorMessage="Please enter address"
                                    ValidationGroup="valEditHomeAddress" ></asp:RequiredFieldValidator>
                            </p>
                            <%--addressLine2--%>
                            <p>
                                <asp:Label ID="Label7" runat="server" Text="Address Line 2" CssClass="propertyLabel"></asp:Label><asp:TextBox
                                    ID="txtAddressLine2" runat="server" CssClass="propertyValue" Text='<% # bind("addressLine2") %>'
                                    ValidationGroup="valEditHomeAddress" ></asp:TextBox>
                            </p>
                            <%--city/town--%>
                            <p>
                                <asp:Label ID="Label8" runat="server" Text="City / Town" CssClass="propertyLabel"></asp:Label><asp:TextBox
                                    ID="txtCityTown" runat="server" CssClass="propertyValue" Text='<% # bind("cityTown") %>' 
                                    ValidationGroup="valEditHomeAddress" ></asp:TextBox>
                                <asp:Label ID="Label19" runat="server" Text="*"></asp:Label>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtCityTown"
                                    Display="Dynamic" ErrorMessage="Please enter City/Town"
                                    ValidationGroup="valEditHomeAddress" ></asp:RequiredFieldValidator>
                            </p>
                            <%--province--%>
                            <p>
                                <asp:Label ID="Label4" runat="server" Text="Province" CssClass="propertyLabel"></asp:Label>
                                <asp:DropDownList ID="ddlProvince" runat="server" CssClass="propertyValue" ValidationGroup="valEditHomeAddress">
                            ...
                            <p>
                                ...
                                <asp:TextBox ID="txtPostalCode_segment1" runat="server" CssClass="propertyValue"
                                    MaxLength="3" Style="text-transform: uppercase" Width="40" Text='<% # String.Format("{0}",Eval("postalCode") ).Substring(0,3) %>'
                                    ValidationGroup="valEditHomeAddress" ></asp:TextBox>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtPostalCode_segment2"
                                    ErrorMessage="Please enter Postal Code." ValidationGroup="valEditHomeAddress"></asp:RequiredFieldValidator>
                                <p class="inputForm-errorMessage">
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Invalid format on Postal Code box 1. E.g L9T."
                                        Display="Dynamic" ControlToValidate="txtPostalCode_segment1" 
                                        ValidationGroup="valEditHomeAddress" ValidationExpression="^([ABCEGHJKLMNPRSTVXYabceghjklmnprstvxy]\d[ABCEGHJKLMNPRSTVWXYZabceghjklmnprstvxy])$">
                                ...
                                <p class="inputForm-errorMessage">
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ErrorMessage="Invalid format on Postal Code box 2. E.g 6C1"
                                        Display="Dynamic" ControlToValidate="txtPostalCode_segment2"
                                        ValidationGroup="valEditHomeAddress"  ValidationExpression="^(\d[ABCEGHJKLMNPRSTVWXYZabceghjklmnprstvxy]\d)$">
                                    </asp:RegularExpressionValidator>
                                </p>
                                <p>
                                </p>
            ...
            <div class="modalPopupLinkbutton-div">
                <asp:LinkButton ID="lnkSaveHomeAddressOnEdit" runat="server" CausesValidation="true"
                    OnCommand="lnkSaveHomeAddressOnEdit_OnCommand" CssClass="linkStyle"
                    ValidationGroup="valEditHomeAddress" >Save</asp:LinkButton>
        ...
        <%--modal popup for edit wte--%>
        <asp:Panel ID="pnlUpdateWTE" runat="server" Width="55%" Style="display: none; border: 0.2em solid gray;
            background: White">
            <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                <ContentTemplate>
                    <asp:Button ID="btnShowUpdateWTE" runat="server" Text="Button" Style="display: none" />
                    <asp:ModalPopupExtender ID="modPopUpShowUpdateWTE" runat="server" TargetControlID="btnShowUpdateWTE"
                        PopupControlID="pnlUpdateWTE" BackgroundCssClass="ModalPopupBackground" CancelControlID="lnkCloseUpdateWTE">
                    </asp:ModalPopupExtender>
                    <%--close--%>
                    <div style="text-align: right; padding-right: 2em">
                        <asp:LinkButton ID="lnkCloseUpdateWTE" runat="server" CausesValidation="false" CssClass="linkbutton-no-line">Close</asp:LinkButton>
                    </div>
                    <h1>
                        Update WTE</h1>
                    <%--formview--%>
                    <asp:FormView ID="fviewUpdateWTE" runat="server" DefaultMode="Edit" CssClass="formviewEdit">
                        <EditItemTemplate>
                            <%--product code--%>
                            <p>
                                <asp:HiddenField ID="hdnWteID" runat="server" Value='<% # bind("wte_id") %>' Visible="false" />
                            </p>
                            <p>
                                <asp:Label ID="Label70" runat="server" Text="Product Code" CssClass="propertyLabel"></asp:Label>
                                <asp:TextBox ID="txtProductCode" runat="server" CssClass="propertyValue" Text='<% # bind("productCode") %>'
                                    ValidationGroup="valUpdateWTE"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator25" runat="server" ErrorMessage="*"
                                    ControlToValidate="txtProductCode" Display="Dynamic" ValidationGroup="valUpdateWTE"></asp:RequiredFieldValidator>
                            </p>
                            <%--description--%>
                            <p>
                                <asp:Label ID="Label71" runat="server" Text="Description" CssClass="propertyLabel"></asp:Label>
                                <asp:TextBox ID="txtDescription" runat="server" CssClass="propertyValue" Text='<% # bind("description") %>'
                                    ValidationGroup="valUpdateWTE"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator26" runat="server" ControlToValidate="txtDescription"
                                    ErrorMessage="*" Display="Dynamic" ValidationGroup="valUpdateWTE"></asp:RequiredFieldValidator>
                            </p>
                            <%--manufacturer--%>
                            <p>
                                <asp:Label ID="Label72" runat="server" Text="Manufacturer" CssClass="propertyLabel"></asp:Label>
                                <asp:TextBox ID="txtManufacturer" runat="server" CssClass="propertyValue" Text='<% # bind("manufacturer") %>'
                                    ValidationGroup="valUpdateWTE"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator27" runat="server" ErrorMessage="*"
                                    ControlToValidate="txtManufacturer" Display="Dynamic" ValidationGroup="valUpdateWTE"></asp:RequiredFieldValidator>
                            </p>
                            <%--date obtained--%>
                            <p>
                                <asp:Label ID="Label73" runat="server" Text="Date obtained" CssClass="propertyLabel"></asp:Label>
                                <asp:TextBox ID="txtDateObtained" runat="server" CssClass="propertyValue" ValidationGroup="valUpdateWTE"
                                    Text='<% #  String.Format("{0:MM/dd/yyyy}", Eval("dateObtained") )  %>' MaxLength="10"></asp:TextBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator28" runat="server" ErrorMessage="*"
                                    ControlToValidate="txtDateObtained" Display="Dynamic" ValidationGroup="valUpdateWTE"></asp:RequiredFieldValidator>
                                <asp:FilteredTextBoxExtender ID="FilteredTextBoxExtender12" runat="server" TargetControlID="txtDateObtained"
                    ...
                    <%--save | cancel --%>
                    <div class="modalPopupLinkbutton-div">
                        <asp:LinkButton ID="lnkUpdateWTE" runat="server" CssClass="linkStyle" ValidationGroup="valUpdateWTE"
                            CausesValidation="true" OnCommand="lnkUpdateWTE_OnCommand">Save</asp:LinkButton>
                        &nbsp
                        <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="false" ValidationGroup="valUpdateWTE"
                            CssClass="linkStyle">Cancel</asp:LinkButton>
                    </div>
                </ContentTemplate>
            </asp:UpdatePanel>
